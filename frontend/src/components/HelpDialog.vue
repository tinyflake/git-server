			...
			<el-tabs v-model="activeTab" type="border-card">
				...
				<el-tab-pane label="数据迁移" name="migration">
					<div class="help-section">
						<h3>功能说明（仅超管）</h3>
						<p>
							数据迁移功能允许超级管理员导出和导入系统的所有数据，用于版本升级、数据备份和系统迁移。
						</p>

						<h3>导出数据</h3>
						<ol>
							<li>点击用户菜单 → "数据迁移"</li>
							<li>查看当前数据统计（用户数、仓库数、大小）</li>
							<li>点击"导出所有数据"按钮</li>
							<li>等待导出完成（会显示进度）</li>
							<li>浏览器自动下载 ZIP 文件</li>
						</ol>
						...
						<ol>
							<li>点击用户菜单 → "数据迁移"</li>
							<li>拖拽或点击上传之前导出的 ZIP 文件</li>
							<li>查看文件信息确认无误</li>
							<li>点击"开始导入"按钮</li>
							<li>在确认对话框中点击"确认导入"</li>
							<li>等待导入完成（会显示详细进度）</li>
							<li>导入完成后自动跳转到登录页</li>
							<li>使用备份文件中的账户密码登录</li>
						</ol>
						...
						<ul>
							<li>0-10%：接收上传文件</li>
							<li>10-30%：解压并验证文件</li>
							<li>30-40%：自动备份当前数据</li>
							<li>40-70%：恢复配置文件</li>
							<li>70-90%：恢复仓库代码</li>
							<li>90-100%：验证数据完整性</li>
						</ul>
						...
						<h3>重要提示</h3>
						<div class="info-box">
							<p><strong>Admin 账户说明：</strong></p>
							<p>
								导入数据后，admin
								账户的密码会被覆盖为备份文件中的密码，不再是新系统的默认密码（123456）。
							</p>
							<p style="margin-top: 12px">
								<strong>数据安全：</strong>
							</p>
							<p>• 导入前系统会自动备份当前数据（保留24小时）</p>
							<p>• 如果导入失败，系统会自动回滚</p>
							<p>• 建议定期导出数据作为备份</p>
						</div>
						...
						<h3>常见问题</h3>
						<h4>Q: 导入后无法登录？</h4>
						<p>A: 使用备份文件中的密码，不是新系统的默认密码。</p>

						<h4>Q: 导入需要多长时间？</h4>
						<p>A: 取决于数据大小：</p>
						<ul>
							<li>小型项目（&lt;100MB）：几秒</li>
							<li>中型项目（100MB-1GB）：几十秒</li>
							<li>大型项目（&gt;1GB）：几分钟</li>
						</ul>
				...
				<el-tab-pane label="常见问题" name="faq">
					<div class="help-section">
						...
						<h3>Q: 如何备份数据？</h3>
						<p>A: 超级管理员可以使用数据迁移功能：</p>
						<ul>
							<li>点击用户菜单 → "数据迁移"</li>
							<li>点击"导出所有数据"</li>
							<li>下载的 ZIP 文件包含所有数据</li>
							<li>建议定期导出并妥善保管</li>
						</ul>
						<p>手动备份需要备份以下内容：</p>
						<ul>
